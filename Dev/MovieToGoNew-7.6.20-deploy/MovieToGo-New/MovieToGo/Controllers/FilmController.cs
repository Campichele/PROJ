...
namespace MovieToGoFilm.Controllers
{
    ...
    public class FilmController : Controller
    {
        ...
        public FilmController(MovieToGoDbContext context)
        {
            ...
            client.BaseAddress = new Uri("http://movietogoapi.azurewebsites.net/");
        ...
        public async Task<Film> AddFilm(Film film)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync("http://movietogoapi.azurewebsites.net/api/Films", content))
                {
