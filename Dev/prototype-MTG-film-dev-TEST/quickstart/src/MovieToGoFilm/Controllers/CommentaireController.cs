...
namespace MovieToGoFilm.Controllers
{
    public class CommentaireController : Controller
    {
        ...
        public CommentaireController(MovieToGoFilmContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["UserId"] = new SelectList(_context.AspNetUsers, "IdUser", "Email");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCommentaire,IdUser,IdFilm,Commentaire1,Statut")] Commentaire commentaire)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.AspNetUsers, "IdUser", "Email", commentaire.Id);
