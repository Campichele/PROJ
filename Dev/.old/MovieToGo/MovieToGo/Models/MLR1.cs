...
{
    public partial class MLR1 : DbContext
    {
        public MLR1()
        {
        }

        public MLR1(DbContextOptions<MLR1> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=ASTRAL\\SQLEXPRESS;Database=MLR1;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Commentaire>(entity =>
            {
                ...
                entity.Property(e => e.FkFilm).HasColumnName("FK_FILM");
            ...
            {
                entity.HasKey(e => e.IdDoit);

                entity.ToTable("DROIT");

                entity.Property(e => e.IdDoit).HasColumnName("ID_DOIT");
            ...
            modelBuilder.Entity<Film>(entity =>
            {
                ...
                entity.Property(e => e.FkActeur).HasColumnName("FK_ACTEUR");

                entity.Property(e => e.FkDistributeur).HasColumnName("FK_DISTRIBUTEUR");

                entity.Property(e => e.FkGenre).HasColumnName("FK_GENRE");

                entity.Property(e => e.FkLangue).HasColumnName("FK_LANGUE");

                entity.Property(e => e.FkNationalite).HasColumnName("FK_NATIONALITE");

                entity.Property(e => e.FkRealisateur)
                    .IsRequired()
                    .HasColumnName("FK_REALISATEUR")
                    .HasMaxLength(32)
                    .IsUnicode(false)
                    .IsFixedLength();

                entity.Property(e => e.FkSoustitre).HasColumnName("FK_SOUSTITRE");
            ...
            modelBuilder.Entity<Utilisateur>(entity =>
            {
                ...
                entity.Property(e => e.FkDroit).HasColumnName("FK_DROIT");
