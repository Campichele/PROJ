...
namespace MovieToGoFilm.Controllers
{
    ...
    {
        private readonly MovieToGoFilmContext _context;

        public UtilisateurController(MovieToGoFilmContext context)
        {
            _context = context;
        }
        ...
        {
            var movieToGoContext = _context.AspNetUsers.Include(u => u.AspNetUserRoles);
        ...
        public async Task<IActionResult> Details(short? id)
        {
            ...
            var utilisateur = await _context.AspNetUsers
        ...
        {
            ViewData["IdDoit"] = new SelectList(_context.AspNetRoles, "IdDoit", "Nom");
            return View();
        }
